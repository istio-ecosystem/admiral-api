...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AssetCluster) DeepCopyInto(out *AssetCluster) {
	*out = *in
	if in.AssetEnvironment != nil {
		in, out := &in.AssetEnvironment, &out.AssetEnvironment
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AssetCluster.
func (in *AssetCluster) DeepCopy() *AssetCluster {
	if in == nil {
		return nil
	}
	out := new(AssetCluster)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AssetDBSpec) DeepCopyInto(out *AssetDBSpec) {
	*out = *in
	if in.AssetClusters != nil {
		in, out := &in.AssetClusters, &out.AssetClusters
		*out = make([]AssetCluster, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
