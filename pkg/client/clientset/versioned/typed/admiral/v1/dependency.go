...
type DependencyInterface interface {
	...
	Apply(ctx context.Context, dependency *admiralv1.DependencyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Dependency, err error)
	ApplyStatus(ctx context.Context, dependency *admiralv1.DependencyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Dependency, err error)
	DependencyExpansion
}
...
func (c *dependencies) Apply(ctx context.Context, dependency *admiralv1.DependencyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Dependency, err error) {
	if dependency == nil {
...
func (c *dependencies) ApplyStatus(ctx context.Context, dependency *admiralv1.DependencyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Dependency, err error) {
	if dependency == nil {
		return nil, fmt.Errorf("dependency provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
