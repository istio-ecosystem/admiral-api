...
import (
	v1 "github.com/istio-ecosystem/admiral-api/pkg/client/clientset/versioned/typed/admiral/v1"
...
func (c *FakeAdmiralV1) AssetDBs(namespace string) v1.AssetDBInterface {
