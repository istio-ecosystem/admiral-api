	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AdmiralV1().TrafficConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdmiralV1().TrafficConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&admiralv1.TrafficConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admiralv1.TrafficConfig{}, f.defaultInformer)
}

func (f *trafficConfigInformer) Lister() v1.TrafficConfigLister {
	return v1.NewTrafficConfigLister(f.Informer().GetIndexer())
}
